...
import sys, asyncio, datetime, json, time
...
bus_service = ServiceBusService(
    ...
    shared_access_key_value='Y89IZY0BwutpsCoOjgLR7/iUyWXrGtr+HKYPg3VX212v4=')  
...
def ClearUpASBQueue():
    ...
    for eventCount in range(totalEventsCount):
        ...
        print(str(currentStamp.now().time().replace(microsecond=0)) + ": Remaining Events : " + str(totalEventsCount - eventCount) + ", Progress% : " + str(format((eventCount / totalEventsCount) * 100, '.3f')))
